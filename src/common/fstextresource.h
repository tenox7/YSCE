...
#define FSGUI_NEWFLTDLG_VISIBILITY                        FsGetTextResource("newfltdlg/visibility",L"Visibility(NM)")
...
#define FSGUI_CFGDLG_VISIBILITY                           FsGetTextResource("configdlg/visibility",L"Visibility (NM)")
...
#define FSGUI_CFGDLG_FIREPARTICLE                         FsGetTextResource("configdlg/drawparticlefire",L"Draw Fire With Particles")
#define FSGUI_CFGDLG_FLAREPARTICLE                        FsGetTextResource("configdlg/drawparticleflare",L"Draw Flare With Particles")
